...
const stripePromise = loadStripe(
  "pk_test_51L4DS7E2DphjbJLtOa2PuodmAXv4W38hrMoMC2IboKOgZqY34zMutHaK1fah8P4zbSCQhGU5YT14uN4UkqpsnM9k00ghxDdsEK"
);

const Payment = () => {
  const { id } = useParams();
  const url = `https://car-manufacturer-app.herokuapp.com/PurchaseInfo/${id}`;
